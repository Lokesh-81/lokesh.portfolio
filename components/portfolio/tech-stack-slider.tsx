...
const row1Technologies: TechLogoItem[] = [
  {
    ...
    category: 'Frontend',
    icon: (
      <svg className="h-6 w-6 text-[#00d8ff]" viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor">
  ...
  },
  {
    ...
    category: 'Framework',
    icon: (
      <svg className="h-6 w-6 fill-current" viewBox="0 0 180 180">
  ...
  },
  {
    ...
    category: 'Runtime',
    icon: (
      <svg className="h-6 w-6 text-[#5fa04e]" viewBox="0 0 32 32" fill="currentColor">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 32 32">
        <path d="M29.8 5.4L16.9 29.5a1 1 0 0 1-1.8 0L2.2 5.4a1 1 0 0 1 1.3-1.4l12.5 5.8 12.5-5.8a1 1 0 0 1 1.3 1.4z" fill="#bd34fe" />
        <path d="M20.5 3.5L16 11.8l-4.5-8.3a1 1 0 0 1 1.2-1.4l3.3 1.5 3.3-1.5a1 1 0 0 1 1.2 1.4z" fill="#ffc700" />
      </svg>
    ),
  },
];
...
const row2Technologies: TechLogoItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-6 w-6 text-sky-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function TechStackSlider() {
  return (
    <div className="w-full overflow-hidden py-8">
      ...
      {/* Row 1: Forward Infinite Scroll */}
      <InfiniteSlider gap={16} duration={28}>
        {row1Technologies.map((tech) => (
          <div
            key={tech.name}
            className="group flex h-16 w-52 shrink-0 items-center gap-3 rounded-2xl border border-zinc-200/80 bg-white/90 px-4 shadow-sm backdrop-blur-md transition-all hover:border-purple-400 hover:shadow-md dark:border-zinc-800/80 dark:bg-zinc-950/90 dark:hover:border-purple-500/50"
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-zinc-50 p-2 dark:bg-zinc-900 group-hover:scale-110 transition-transform">
              {tech.icon}
            </div>
            <div className="min-w-0">
              <span className="block truncate text-sm font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                {tech.name}
              </span>
              <span className="block truncate text-[10px] font-mono uppercase text-zinc-400 dark:text-zinc-500">
                {tech.category}
              </span>
            </div>
          </div>
      ...
      <div className="mt-4">
        <InfiniteSlider gap={16} reverse duration={28}>
