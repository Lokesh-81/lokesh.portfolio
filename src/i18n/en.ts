export const en = {
  ...
  // Hero Section
  'hero.roleTag': 'Full Stack Developer',
  ...
  'hero.statusBadge': 'AVAILABLE FOR NEW OPPORTUNITIES',
  'hero.location': 'Hyderabad, India',
  'hero.timeZone': 'IST (UTC+5:30)',
  'hero.techTicker': 'Core Technologies & Frameworks',
  ...
  'about.introGoal':
    'driven by the craft of building resilient web platforms and AI-powered products.',
  ...
  'about.philosophy1.desc':
    'Interfaces engineered with optical precision, fluid transitions, mathematical spacing, and strict adherence to accessibility and performance.',
  'about.philosophy2.title': 'Scalable Architecture',
  'about.philosophy2.desc':
    'End-to-end type safety, resilient API design, normalized schemas, and clean state handling that maintains velocity as platforms scale.',
  'about.philosophy3.title': 'AI-Native Systems',
  'about.philosophy3.desc':
    'Designing contextual AI experiences with streaming LLMs, retrieval pipelines, semantic caching, and intelligent workflows.',
  ...
  'contact.githubSection': 'GitHub Profiles',
